...
class Customer extends \common\models\Customer
{
    ...
    {
        return [
            [['business_type', 'status', 'crated_at', 'created_by', 'updated_at', 'udpated_by','customer_group_id','company_id','payment_term_id','payment_method_id','work_type_id','customer_invoice_id'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'customer_invoice_id'=>'ลูกค้าที่ต้องวางบิล',
        ];
    }
