...
class Employeefine extends \common\models\EmployeeFine
{
    ...
    public static function findNo($id){
        $model = Employeefine::find()->where(['id'=>$id])->one();
        return $model!= null?$model->case_no:'';
    }
    ...
    {
        $model = Employeefine::find()->MAX('case_no');
