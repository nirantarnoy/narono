...
/** @var backend\models\AccidentSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'อุบัติเหตุ';
...
//        'filterModel' => $searchModel,
        ...
        'columns' => [
            ...
            'case_no',
            [
                'attribute' => 'accident_title_id',
                'value' => function ($data) {
                    return \backend\models\Accidenttitle::findNo($data->accident_title_id);
                }
            ],
            'place',
            [
