...
if($search_company_id != null){
    $model = $model->andfilterWhere(['company_id' => $search_company_id])->andFilterWhere(['company_id' => $search_company_id]);
}
if($search_office_id != null){
    $model = $model->andWhere(['office_id' => $search_office_id])->andFilterWhere(['office_id' => $search_office_id]);
}
