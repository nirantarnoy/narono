...
/** @var backend\models\ComplainSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'ข้อร้องเรียน';
...
//        'filterModel' => $searchModel,
        ...
        'columns' => [
            ...
            'trans_date',
            [
                    'attribute' => 'complain_title_id',
                'value' => function ($data) {
                    return \backend\models\Complaintitle::findNo($data->complain_title_id);
                }
            ],
            'place',
            [
