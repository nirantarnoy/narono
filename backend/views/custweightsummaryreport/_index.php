        ...
        <div class="col-lg-12">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><b><?= number_format($total_m1 + $total_m2 + $total_m3 + $total_m4 + $total_m5 + $total_m6 + $total_m7 + $total_m8 + $total_m9 + $total_m10 + $total_m11 + $total_m12) ?></b></td>
