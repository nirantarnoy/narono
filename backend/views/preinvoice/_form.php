                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" class="form-control line-work-queue-amount"
                                       name="line_work_queue_amount[]" min="0" step="any" onchange="calinvoiceall();">
                            </td>
                        ...
                        <?php if ($model_line != null): ?>
                            <?php foreach ($model_line as $value): ?>
                                ...
                                <tr data-var="<?=$value->id;?>">
                                    ...
                                    <td>
                                        <input type="number" class="form-control line-work-queue-amount"
                                               name="line_work_queue_amount[]" min="0" step="any" value="<?=$value->total_amount?>" onchange="calinvoiceall();">
                                    </td>
                                    <td style="text-align: center;">
                                        <div class="btn btn-danger" onclick="removeline($(this))">ลบ</div>
                                    </td>
