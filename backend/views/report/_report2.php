...
if($car_search != null){
    $model = \backend\models\Workqueue::find()->innerJoin('car')->on('work_queue.car_id = car.id')->where(['like', 'car.plate_no', $car_search])->groupBy(['car.plate_no'])->orderBy(['id' => SORT_ASC])->all();
}
