...
class WorkQueue extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['work_queue_type'], 'required'],
            [['work_queue_date'], 'safe'],
            [['customer_id', 'emp_assign', 'status', 'create_at', 'created_by', 'updated_at', 'updated_by','route_plan_id','tail_id','car_id','tail_back_id','approve_status','approve_by','is_labur','is_express_road','is_other','work_option_type_id','is_invoice','company_id','work_queue_type'], 'integer'],
            [['work_queue_no','go_deduct_reason','back_reason','dp_no','code_6_digit'], 'string', 'max' => 255],
